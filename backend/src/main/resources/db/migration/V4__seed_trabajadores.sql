...
INSERT INTO trabajadores (tipo_documento, numero_documento, nombres, apellidos, telefono, correo_notificaciones, tipo_contrato, sede_id, cargo_id, usuario_id, estado)
VALUES
...
('DNI', '78901234', 'Patricia Vanessa', 'Flores Benítez', '978901234', 'pflores@empresa.com', 'PERMANENTE', 2, 2, NULL, 'ACTIVO'),
('DNI', '65432109', 'Miguel Ángel', 'Cruz Paredes', '965432109', 'mcruz@empresa.com', 'TEMPORAL', 3, 1, NULL, 'ACTIVO'),
